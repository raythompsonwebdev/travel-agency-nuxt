    ...
    <form id="holiday-search-form" @submit.prevent="onSubmit">
      ...
      <label for="date" class="label-wide"
        ...
        <select v-model="date" name="date" class="select-date-year">
          <option v-for="date in searchform.searchformitems[1].date" :key="date.id" :value="date">
            {{ date }}
          </option>
        </select>
        <select id="select-month" v-model="month" name="month">
          <option v-for="month in searchform.searchformitems[2].month" :key="month.id" :value="month">
            {{ month }}
          </option>
        </select>
        <select v-model="year" name="year" class="select-date-year">
          <option v-for="year in searchform.searchformitems[3].year" :key="year.id" :value="year">
            {{ year }}
          </option>
        </select>
      </label>
      ...
      <label class="label-half" for="board"
        ...
        <select v-model="board" name="board" class="select-half">
          <option v-for="board in searchform.searchformitems[5].board" :key="board.id" :value="board">
            {{ board }}
          </option>
        </select>
      </label>
      ...
      <label class="label-half" for="star"
        ...
        <select v-model="star" name="star" class="select-half">
          <option v-for="star in searchform.searchformitems[6].star" :key="star.id" :value="star">
            {{ star }}
          </option>
        </select>
      </label>
      ...
      <label class="label-half" for="adults"
        ...
        <select v-model.number="adults" name="adults" class="select-half">
          <option v-for="adult in searchform.searchformitems[7].adults" :key="adult.id" :value="adult">
            {{ adult }}
          </option>
        </select>
      </label>
      <label class="label-half" for="children"
        ...
        <select v-model.number="children" name="children" class="select-half">
          <option v-for="child in searchform.searchformitems[8].children" :key="child.id" :value="child">
            {{ child }}
          </option>
        </select>
      </label>
